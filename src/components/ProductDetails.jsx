        ...
        <div className="md:p-0">
            <div className="flex flex-col items-center justify-center">
                <div className="max-w-6xl lg:pb-6 px-4 flex flex-col items-center">
                    <h2 className="text-left font-bold hyphens-manual lg:break-words text-4xl leading-tight md:leading-none md:text-8xl lg:text-center">Smart&shy;Bottlingplant™ <br /> A Leap Ahead</h2>
